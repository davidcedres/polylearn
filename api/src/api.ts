...
app.post('/users', ClerkExpressRequireAuth(),
    async (req: RequireAuthProp<Request>, res) => {
...
app.post("/skills", ClerkExpressRequireAuth(),
    async (req: RequireAuthProp<Request>, res) => {
...
app.get("/skills/:id", ClerkExpressRequireAuth(),
    async (req: RequireAuthProp<Request>, res) => {
...
app.post("/questions", ClerkExpressRequireAuth(),
    async (req: RequireAuthProp<Request>, res) => {
...
app.get("/questions", ClerkExpressRequireAuth(),
    async (req: RequireAuthProp<Request>, res) => {
...
app.post("/submits", ClerkExpressRequireAuth(),
    async (req: RequireAuthProp<Request>, res) => {
        try {
...
app.get("/submits", ClerkExpressRequireAuth(),
    async (req: RequireAuthProp<Request>, res) => {
        const submits = await prisma.submit.findMany({
            include: {
                answer: {
...
app.get("/dataset", ClerkExpressRequireAuth(),
    async (req: RequireAuthProp<Request>, res) => {
